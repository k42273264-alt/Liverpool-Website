document.addEventListener('DOMContentLoaded', () => {
    ...
    const initVenueModal = () => {
      ...
      const venueDetails = {
        'Vista Restaurant & Vu Bar & Terrace': {
          details: 'Vista Restaurant & Vu Bar & Terrace offers fine dining with seasonal menus featuring locally sourced ingredients. Accommodating up to 120 guests on the upper floors, it provides breathtaking waterfront views and is ideal for special occasions.'
        }
      };
